...
@section('content')
    <div class="container" style="max-width: 800px;">
        <div class="d-flex align-items-center justify-content-between mb-3">
            <h1 class="me-3">Modifier le matériel: <span style="color: blue;">{{ $materiel->designation }}</span>
            </h1>
            <a href="{{ route('materiel.index') }}" class="btn btn-primary">
        ...
        <form action="{{ route('materiel.update', ['materiel' => $materiel]) }}" method="POST">
            @csrf
            @method('PUT')
